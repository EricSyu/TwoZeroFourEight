...
public class MainActivity extends AppCompatActivity {
    ...
    private void save() {
        ...
        Component[][] field = view.game.grid.field;
        Component[][] undoField = view.game.grid.undoField;
    ...
    private void load() {
        ...
        for (int xx = 0; xx < view.game.grid.field.length; xx++) {
            for (int yy = 0; yy < view.game.grid.field[0].length; yy++) {
                ...
                if (value > 0) {
                    view.game.grid.field[xx][yy] = new Component(xx, yy, value);
                } else if (value == 0) {
                ...
                if (undoValue > 0) {
                    view.game.grid.undoField[xx][yy] = new Component(xx, yy, undoValue);
                } else if (value == 0) {
